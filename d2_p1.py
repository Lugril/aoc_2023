...
for line in input.splitlines():
    ...
    _, game = game.split(" ")
    for gamesets in rest.split(";"):
        print ("game {}: {}".format (game,gamesets))
        for sets in gamesets.split(","):
            #print(sets)
            _, num, color = sets.split(" ")
            num=int(num)
            if (color == "red") and (num > max_red):
                game_validity = False 
                print ("Game {}: set as invalid, {} red were found".format(game,num))
                break
            if (color == "green") and (num > max_green):
                game_validity = False 
                print ("Game {}: set as invalid, {} green were found".format(game,num))
                break
            if (color == "blue") and (num > max_blue):
                game_validity = False 
                print ("Game {}: set as invalid, {} blue were found".format(game,num))
                break
        if game_validity == False:
            break
    if game_validity == True:
        sum_valid_games += int(game)
    else:
        print ("game", game, "is invalid")
